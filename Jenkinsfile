  ...
  stages 
  {
    ...
    stage('Push Image to ECR') 
    {
      ...
      steps {
        ...
        sh 'aws ecr get-login-password --region us-east-1 | docker login -u AWS -p $(aws ecr get-login-password --region us-east-1) 548341944327.dkr.ecr.us-east-1.amazonaws.com'
